...
begin
  ...
  insert into kontrakt_tabeller (tabell, klassifisert, uten_policy_ok) values
    ...
    ('produksjonsplan_hode', false, false),
    ('produksjonsplan_linjer', false, false),
