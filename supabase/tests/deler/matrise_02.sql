...
--
-- DEL 2 AV 11. Hele matrisen er for stor for Supabase SQL
...
-- --- bilagssum: forutsetninger og proberader ---
insert into public.bilagssum (id, retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values ('1f29199e-0000-4000-8000-00001f29199e', 'aaaa0000-0000-4000-8000-000000000000', null, '0030', date '2026-01-01' + 30, '627 Renhold', '6270 Renhold', 'renhold', 'Sonde nullA', 1234.50);
insert into public.bilagssum (id, retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values ('1f29199f-0000-4000-8000-00001f29199f', 'bbbb0000-0000-4000-8000-000000000000', null, '0031', date '2026-01-01' + 31, '627 Renhold', '6270 Renhold', 'renhold', 'Sonde nullB', 1234.50);
insert into public.bilagssum (id, retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values ('413a66d7-0000-4000-8000-0000413a66d7', 'aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000001', '0032', date '2026-01-01' + 32, '627 Renhold', '6270 Renhold', 'renhold', 'Sonde fastA1', 1234.50);
insert into public.bilagssum (id, retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values ('413a66d8-0000-4000-8000-0000413a66d8', 'aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000002', '0033', date '2026-01-01' + 33, '627 Renhold', '6270 Renhold', 'renhold', 'Sonde fastA2', 1234.50);
insert into public.bilagssum (id, retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values ('413a66d9-0000-4000-8000-0000413a66d9', 'aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000003', '0034', date '2026-01-01' + 34, '627 Renhold', '6270 Renhold', 'renhold', 'Sonde fastA3', 1234.50);
insert into public.bilagssum (id, retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values ('413a66f6-0000-4000-8000-0000413a66f6', 'bbbb0000-0000-4000-8000-000000000000', 'b1110000-0000-4000-8000-000000000001', '0035', date '2026-01-01' + 35, '627 Renhold', '6270 Renhold', 'renhold', 'Sonde fastB1', 1234.50);
insert into public.bilagssum (id, retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values ('413a66f7-0000-4000-8000-0000413a66f7', 'bbbb0000-0000-4000-8000-000000000000', 'b1110000-0000-4000-8000-000000000002', '0036', date '2026-01-01' + 36, '627 Renhold', '6270 Renhold', 'renhold', 'Sonde fastB2', 1234.50);

create or replace function pg_temp.nyrad_bilagssum(p_retailer uuid, p_stasjon uuid, p_merke text)
returns uuid language plpgsql security definer as $fn$
declare
  ny uuid;
begin
  insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr)
  values (p_retailer, p_stasjon, lpad((9000 + nextval('tenant_teller'::regclass) % 1000)::text, 4, '0'), date '2030-01-01' + nextval('tenant_teller'::regclass)::int, '627 Renhold', '6270 Renhold', 'renhold', 'Sonde ' || p_merke || '-' || nextval('tenant_teller'::regclass) || '', 1234.50)
  returning id into ny;
  return ny;
end $fn$;
-- --- bp_aar: forutsetninger og proberader ---
insert into public.bp_aar (id, stasjon_id, retailer_id, ar, format, timer_aar) values ('f4eb7255-0000-4000-8000-0000f4eb7255', 'a1110000-0000-4000-8000-000000000001', 'aaaa0000-0000-4000-8000-000000000000', 2137, 'st1_bp26', 12000);
insert into public.bp_aar (id, stasjon_id, retailer_id, ar, format, timer_aar) values ('f4eb7256-0000-4000-8000-0000f4eb7256', 'a1110000-0000-4000-8000-000000000002', 'aaaa0000-0000-4000-8000-000000000000', 2138, 'st1_bp26', 12000);
insert into public.bp_aar (id, stasjon_id, retailer_id, ar, format, timer_aar) values ('f4eb7257-0000-4000-8000-0000f4eb7257', 'a1110000-0000-4000-8000-000000000003', 'aaaa0000-0000-4000-8000-000000000000', 2139, 'st1_bp26', 12000);
insert into public.bp_aar (id, stasjon_id, retailer_id, ar, format, timer_aar) values ('f4eb7274-0000-4000-8000-0000f4eb7274', 'b1110000-0000-4000-8000-000000000001', 'bbbb0000-0000-4000-8000-000000000000', 2140, 'st1_bp26', 12000);
insert into public.bp_aar (id, stasjon_id, retailer_id, ar, format, timer_aar) values ('f4eb7275-0000-4000-8000-0000f4eb7275', 'b1110000-0000-4000-8000-000000000002', 'bbbb0000-0000-4000-8000-000000000000', 2141, 'st1_bp26', 12000);
...
select pg_temp.skriv_tillatt('bemanning_fast_vakt owner_A INSERT A1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde owner_AA1'', 3, date ''2026-01-01'' + 42, 7, 15)');
select pg_temp.skriv_tillatt('bemanning_fast_vakt owner_A INSERT A2', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000002'', ''Sonde owner_AA2'', 3, date ''2026-01-01'' + 43, 7, 15)');
select pg_temp.skriv_tillatt('bemanning_fast_vakt owner_A INSERT A3', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000003'', ''Sonde owner_AA3'', 3, date ''2026-01-01'' + 44, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt owner_A INSERT B1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde owner_AB1'', 3, date ''2026-01-01'' + 45, 7, 15)');
...
select pg_temp.som_eier();
insert into public.bemanning_fast_vakt (id, stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values ('e15ccef7-0000-4000-8000-0000e15ccef7', 'a1110000-0000-4000-8000-000000000001', 'Sonde gjenowner_AA1', 3, date '2026-01-01' + 46, 7, 15);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fast_vakt (id, stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values ('e15ccef8-0000-4000-8000-0000e15ccef8', 'a1110000-0000-4000-8000-000000000002', 'Sonde gjenowner_AA2', 3, date '2026-01-01' + 47, 7, 15);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fast_vakt (id, stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values ('e15ccef9-0000-4000-8000-0000e15ccef9', 'a1110000-0000-4000-8000-000000000003', 'Sonde gjenowner_AA3', 3, date '2026-01-01' + 48, 7, 15);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_fast_vakt manager_A1 INSERT A1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde manager_A1A1'', 3, date ''2026-01-01'' + 49, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt manager_A1 INSERT A2', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000002'', ''Sonde manager_A1A2'', 3, date ''2026-01-01'' + 50, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt manager_A1 INSERT A3', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000003'', ''Sonde manager_A1A3'', 3, date ''2026-01-01'' + 51, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt manager_A1 INSERT B1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde manager_A1B1'', 3, date ''2026-01-01'' + 52, 7, 15)');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fast_vakt (id, stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values ('e15ccef7-0000-4000-8000-0000e15ccef7', 'a1110000-0000-4000-8000-000000000001', 'Sonde gjenmanager_A1A1', 3, date '2026-01-01' + 53, 7, 15);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a001');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_fast_vakt manager_A12 INSERT A1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde manager_A12A1'', 3, date ''2026-01-01'' + 54, 7, 15)');
select pg_temp.skriv_tillatt('bemanning_fast_vakt manager_A12 INSERT A2', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000002'', ''Sonde manager_A12A2'', 3, date ''2026-01-01'' + 55, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt manager_A12 INSERT A3', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000003'', ''Sonde manager_A12A3'', 3, date ''2026-01-01'' + 56, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt manager_A12 INSERT B1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde manager_A12B1'', 3, date ''2026-01-01'' + 57, 7, 15)');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fast_vakt (id, stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values ('e15ccef7-0000-4000-8000-0000e15ccef7', 'a1110000-0000-4000-8000-000000000001', 'Sonde gjenmanager_A12A1', 3, date '2026-01-01' + 58, 7, 15);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a012');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fast_vakt (id, stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values ('e15ccef8-0000-4000-8000-0000e15ccef8', 'a1110000-0000-4000-8000-000000000002', 'Sonde gjenmanager_A12A2', 3, date '2026-01-01' + 59, 7, 15);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a012');
select pg_temp.som_eier();
...
select pg_temp.skriv_avvist('bemanning_fast_vakt tablet_A1 INSERT A1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde tablet_A1A1'', 3, date ''2026-01-01'' + 60, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt tablet_A1 INSERT A2', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000002'', ''Sonde tablet_A1A2'', 3, date ''2026-01-01'' + 61, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt tablet_A1 INSERT A3', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000003'', ''Sonde tablet_A1A3'', 3, date ''2026-01-01'' + 62, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt tablet_A1 INSERT B1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde tablet_A1B1'', 3, date ''2026-01-01'' + 63, 7, 15)');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_fast_vakt owner_B INSERT B1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde owner_BB1'', 3, date ''2026-01-01'' + 64, 7, 15)');
select pg_temp.skriv_tillatt('bemanning_fast_vakt owner_B INSERT B2', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''b1110000-0000-4000-8000-000000000002'', ''Sonde owner_BB2'', 3, date ''2026-01-01'' + 65, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt owner_B INSERT A1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde owner_BA1'', 3, date ''2026-01-01'' + 66, 7, 15)');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fast_vakt (id, stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values ('e15ccf16-0000-4000-8000-0000e15ccf16', 'b1110000-0000-4000-8000-000000000001', 'Sonde gjenowner_BB1', 3, date '2026-01-01' + 67, 7, 15);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fast_vakt (id, stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values ('e15ccf17-0000-4000-8000-0000e15ccf17', 'b1110000-0000-4000-8000-000000000002', 'Sonde gjenowner_BB2', 3, date '2026-01-01' + 68, 7, 15);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_fast_vakt manager_B1 INSERT B1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde manager_B1B1'', 3, date ''2026-01-01'' + 69, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt manager_B1 INSERT B2', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''b1110000-0000-4000-8000-000000000002'', ''Sonde manager_B1B2'', 3, date ''2026-01-01'' + 70, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt manager_B1 INSERT A1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde manager_B1A1'', 3, date ''2026-01-01'' + 71, 7, 15)');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fast_vakt (id, stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values ('e15ccf16-0000-4000-8000-0000e15ccf16', 'b1110000-0000-4000-8000-000000000001', 'Sonde gjenmanager_B1B1', 3, date '2026-01-01' + 72, 7, 15);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b001');
select pg_temp.som_eier();
...
select pg_temp.skriv_avvist('bemanning_fast_vakt tablet_B1 INSERT B1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde tablet_B1B1'', 3, date ''2026-01-01'' + 73, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt tablet_B1 INSERT B2', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''b1110000-0000-4000-8000-000000000002'', ''Sonde tablet_B1B2'', 3, date ''2026-01-01'' + 74, 7, 15)');
select pg_temp.skriv_avvist('bemanning_fast_vakt tablet_B1 INSERT A1', 'insert into public.bemanning_fast_vakt (stasjon_id, navn, ukedag, gjelder_fra, fra_time, til_time) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde tablet_B1A1'', 3, date ''2026-01-01'' + 75, 7, 15)');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_fravaer owner_A INSERT A1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 76, date ''2026-01-01'' + 76, ''Sonde'')');
select pg_temp.skriv_tillatt('bemanning_fravaer owner_A INSERT A2', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000002'', ''Sonde Sondesen'', date ''2026-01-01'' + 77, date ''2026-01-01'' + 77, ''Sonde'')');
select pg_temp.skriv_tillatt('bemanning_fravaer owner_A INSERT A3', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000003'', ''Sonde Sondesen'', date ''2026-01-01'' + 78, date ''2026-01-01'' + 78, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer owner_A INSERT B1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 79, date ''2026-01-01'' + 79, ''Sonde'')');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fravaer (id, stasjon_id, navn, fra_dato, til_dato, arsak) values ('ebd5f3cd-0000-4000-8000-0000ebd5f3cd', 'a1110000-0000-4000-8000-000000000001', 'Sonde Sondesen', date '2026-01-01' + 80, date '2026-01-01' + 80, 'Sonde');
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fravaer (id, stasjon_id, navn, fra_dato, til_dato, arsak) values ('ebd5f3ce-0000-4000-8000-0000ebd5f3ce', 'a1110000-0000-4000-8000-000000000002', 'Sonde Sondesen', date '2026-01-01' + 81, date '2026-01-01' + 81, 'Sonde');
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fravaer (id, stasjon_id, navn, fra_dato, til_dato, arsak) values ('ebd5f3cf-0000-4000-8000-0000ebd5f3cf', 'a1110000-0000-4000-8000-000000000003', 'Sonde Sondesen', date '2026-01-01' + 82, date '2026-01-01' + 82, 'Sonde');
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_fravaer manager_A1 INSERT A1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 83, date ''2026-01-01'' + 83, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer manager_A1 INSERT A2', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000002'', ''Sonde Sondesen'', date ''2026-01-01'' + 84, date ''2026-01-01'' + 84, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer manager_A1 INSERT A3', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000003'', ''Sonde Sondesen'', date ''2026-01-01'' + 85, date ''2026-01-01'' + 85, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer manager_A1 INSERT B1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 86, date ''2026-01-01'' + 86, ''Sonde'')');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fravaer (id, stasjon_id, navn, fra_dato, til_dato, arsak) values ('ebd5f3cd-0000-4000-8000-0000ebd5f3cd', 'a1110000-0000-4000-8000-000000000001', 'Sonde Sondesen', date '2026-01-01' + 87, date '2026-01-01' + 87, 'Sonde');
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a001');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_fravaer manager_A12 INSERT A1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 88, date ''2026-01-01'' + 88, ''Sonde'')');
select pg_temp.skriv_tillatt('bemanning_fravaer manager_A12 INSERT A2', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000002'', ''Sonde Sondesen'', date ''2026-01-01'' + 89, date ''2026-01-01'' + 89, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer manager_A12 INSERT A3', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000003'', ''Sonde Sondesen'', date ''2026-01-01'' + 90, date ''2026-01-01'' + 90, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer manager_A12 INSERT B1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 91, date ''2026-01-01'' + 91, ''Sonde'')');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fravaer (id, stasjon_id, navn, fra_dato, til_dato, arsak) values ('ebd5f3cd-0000-4000-8000-0000ebd5f3cd', 'a1110000-0000-4000-8000-000000000001', 'Sonde Sondesen', date '2026-01-01' + 92, date '2026-01-01' + 92, 'Sonde');
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a012');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fravaer (id, stasjon_id, navn, fra_dato, til_dato, arsak) values ('ebd5f3ce-0000-4000-8000-0000ebd5f3ce', 'a1110000-0000-4000-8000-000000000002', 'Sonde Sondesen', date '2026-01-01' + 93, date '2026-01-01' + 93, 'Sonde');
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a012');
select pg_temp.som_eier();
...
select pg_temp.skriv_avvist('bemanning_fravaer tablet_A1 INSERT A1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 94, date ''2026-01-01'' + 94, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer tablet_A1 INSERT A2', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000002'', ''Sonde Sondesen'', date ''2026-01-01'' + 95, date ''2026-01-01'' + 95, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer tablet_A1 INSERT A3', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000003'', ''Sonde Sondesen'', date ''2026-01-01'' + 96, date ''2026-01-01'' + 96, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer tablet_A1 INSERT B1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 97, date ''2026-01-01'' + 97, ''Sonde'')');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_fravaer owner_B INSERT B1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 98, date ''2026-01-01'' + 98, ''Sonde'')');
select pg_temp.skriv_tillatt('bemanning_fravaer owner_B INSERT B2', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''b1110000-0000-4000-8000-000000000002'', ''Sonde Sondesen'', date ''2026-01-01'' + 99, date ''2026-01-01'' + 99, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer owner_B INSERT A1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 100, date ''2026-01-01'' + 100, ''Sonde'')');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fravaer (id, stasjon_id, navn, fra_dato, til_dato, arsak) values ('ebd5f3ec-0000-4000-8000-0000ebd5f3ec', 'b1110000-0000-4000-8000-000000000001', 'Sonde Sondesen', date '2026-01-01' + 101, date '2026-01-01' + 101, 'Sonde');
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fravaer (id, stasjon_id, navn, fra_dato, til_dato, arsak) values ('ebd5f3ed-0000-4000-8000-0000ebd5f3ed', 'b1110000-0000-4000-8000-000000000002', 'Sonde Sondesen', date '2026-01-01' + 102, date '2026-01-01' + 102, 'Sonde');
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_fravaer manager_B1 INSERT B1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 103, date ''2026-01-01'' + 103, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer manager_B1 INSERT B2', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''b1110000-0000-4000-8000-000000000002'', ''Sonde Sondesen'', date ''2026-01-01'' + 104, date ''2026-01-01'' + 104, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer manager_B1 INSERT A1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 105, date ''2026-01-01'' + 105, ''Sonde'')');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_fravaer (id, stasjon_id, navn, fra_dato, til_dato, arsak) values ('ebd5f3ec-0000-4000-8000-0000ebd5f3ec', 'b1110000-0000-4000-8000-000000000001', 'Sonde Sondesen', date '2026-01-01' + 106, date '2026-01-01' + 106, 'Sonde');
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b001');
select pg_temp.som_eier();
...
select pg_temp.skriv_avvist('bemanning_fravaer tablet_B1 INSERT B1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''b1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 107, date ''2026-01-01'' + 107, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer tablet_B1 INSERT B2', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''b1110000-0000-4000-8000-000000000002'', ''Sonde Sondesen'', date ''2026-01-01'' + 108, date ''2026-01-01'' + 108, ''Sonde'')');
select pg_temp.skriv_avvist('bemanning_fravaer tablet_B1 INSERT A1', 'insert into public.bemanning_fravaer (stasjon_id, navn, fra_dato, til_dato, arsak) values (''a1110000-0000-4000-8000-000000000001'', ''Sonde Sondesen'', date ''2026-01-01'' + 109, date ''2026-01-01'' + 109, ''Sonde'')');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_vindu owner_A INSERT A1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 258, 6, 22, 1)');
select pg_temp.skriv_tillatt('bemanning_vindu owner_A INSERT A2', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000002'', 1, date ''2026-01-01'' + 259, 6, 22, 1)');
select pg_temp.skriv_tillatt('bemanning_vindu owner_A INSERT A3', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000003'', 1, date ''2026-01-01'' + 260, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu owner_A INSERT B1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''b1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 261, 6, 22, 1)');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_vindu (id, stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values ('f753c28c-0000-4000-8000-0000f753c28c', 'a1110000-0000-4000-8000-000000000001', 1, date '2026-01-01' + 262, 6, 22, 1);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_vindu (id, stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values ('f753c28d-0000-4000-8000-0000f753c28d', 'a1110000-0000-4000-8000-000000000002', 1, date '2026-01-01' + 263, 6, 22, 1);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_vindu (id, stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values ('f753c28e-0000-4000-8000-0000f753c28e', 'a1110000-0000-4000-8000-000000000003', 1, date '2026-01-01' + 264, 6, 22, 1);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_vindu manager_A1 INSERT A1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 265, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu manager_A1 INSERT A2', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000002'', 1, date ''2026-01-01'' + 266, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu manager_A1 INSERT A3', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000003'', 1, date ''2026-01-01'' + 267, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu manager_A1 INSERT B1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''b1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 268, 6, 22, 1)');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_vindu (id, stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values ('f753c28c-0000-4000-8000-0000f753c28c', 'a1110000-0000-4000-8000-000000000001', 1, date '2026-01-01' + 269, 6, 22, 1);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a001');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_vindu manager_A12 INSERT A1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 270, 6, 22, 1)');
select pg_temp.skriv_tillatt('bemanning_vindu manager_A12 INSERT A2', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000002'', 1, date ''2026-01-01'' + 271, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu manager_A12 INSERT A3', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000003'', 1, date ''2026-01-01'' + 272, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu manager_A12 INSERT B1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''b1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 273, 6, 22, 1)');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_vindu (id, stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values ('f753c28c-0000-4000-8000-0000f753c28c', 'a1110000-0000-4000-8000-000000000001', 1, date '2026-01-01' + 274, 6, 22, 1);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a012');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_vindu (id, stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values ('f753c28d-0000-4000-8000-0000f753c28d', 'a1110000-0000-4000-8000-000000000002', 1, date '2026-01-01' + 275, 6, 22, 1);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a012');
select pg_temp.som_eier();
...
select pg_temp.skriv_avvist('bemanning_vindu tablet_A1 INSERT A1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 276, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu tablet_A1 INSERT A2', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000002'', 1, date ''2026-01-01'' + 277, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu tablet_A1 INSERT A3', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000003'', 1, date ''2026-01-01'' + 278, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu tablet_A1 INSERT B1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''b1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 279, 6, 22, 1)');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_vindu owner_B INSERT B1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''b1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 280, 6, 22, 1)');
select pg_temp.skriv_tillatt('bemanning_vindu owner_B INSERT B2', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''b1110000-0000-4000-8000-000000000002'', 1, date ''2026-01-01'' + 281, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu owner_B INSERT A1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 282, 6, 22, 1)');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_vindu (id, stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values ('f753c2ab-0000-4000-8000-0000f753c2ab', 'b1110000-0000-4000-8000-000000000001', 1, date '2026-01-01' + 283, 6, 22, 1);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_vindu (id, stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values ('f753c2ac-0000-4000-8000-0000f753c2ac', 'b1110000-0000-4000-8000-000000000002', 1, date '2026-01-01' + 284, 6, 22, 1);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bemanning_vindu manager_B1 INSERT B1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''b1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 285, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu manager_B1 INSERT B2', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''b1110000-0000-4000-8000-000000000002'', 1, date ''2026-01-01'' + 286, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu manager_B1 INSERT A1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 287, 6, 22, 1)');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bemanning_vindu (id, stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values ('f753c2ab-0000-4000-8000-0000f753c2ab', 'b1110000-0000-4000-8000-000000000001', 1, date '2026-01-01' + 288, 6, 22, 1);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b001');
select pg_temp.som_eier();
...
select pg_temp.skriv_avvist('bemanning_vindu tablet_B1 INSERT B1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''b1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 289, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu tablet_B1 INSERT B2', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''b1110000-0000-4000-8000-000000000002'', 1, date ''2026-01-01'' + 290, 6, 22, 1)');
select pg_temp.skriv_avvist('bemanning_vindu tablet_B1 INSERT A1', 'insert into public.bemanning_vindu (stasjon_id, ukedag, gjelder_fra, fra_time, til_time, min_bemanning) values (''a1110000-0000-4000-8000-000000000001'', 1, date ''2026-01-01'' + 291, 6, 22, 1)');
select pg_temp.som_eier();
...
-- =====================================================================
-- bilagssum  (retailer_or_station, warm)
-- =====================================================================
select pg_temp.sett_gruppe('bilagssum');

select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');   -- owner_A
select pg_temp.paastand('bilagssum owner_A SELECT A1 -> ser', exists (select 1 from public.bilagssum where id = '413a66d7-0000-4000-8000-0000413a66d7'), 'positiv');
select pg_temp.paastand('bilagssum owner_A SELECT A2 -> ser', exists (select 1 from public.bilagssum where id = '413a66d8-0000-4000-8000-0000413a66d8'), 'positiv');
select pg_temp.paastand('bilagssum owner_A SELECT A3 -> ser', exists (select 1 from public.bilagssum where id = '413a66d9-0000-4000-8000-0000413a66d9'), 'positiv');
select pg_temp.paastand('bilagssum owner_A SELECT B1 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66f6-0000-4000-8000-0000413a66f6'), 'negativ');
select pg_temp.skriv_tillatt('bilagssum owner_A INSERT A1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000001'', ''0292'', date ''2026-01-01'' + 292, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde owner_AA1'', 1234.50)');
select pg_temp.skriv_tillatt('bilagssum owner_A INSERT A2', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000002'', ''0293'', date ''2026-01-01'' + 293, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde owner_AA2'', 1234.50)');
select pg_temp.skriv_tillatt('bilagssum owner_A INSERT A3', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000003'', ''0294'', date ''2026-01-01'' + 294, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde owner_AA3'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum owner_A INSERT B1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''bbbb0000-0000-4000-8000-000000000000'', ''b1110000-0000-4000-8000-000000000001'', ''0295'', date ''2026-01-01'' + 295, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde owner_AB1'', 1234.50)');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000001', 'owner_A-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.skriv_tillatt('bilagssum owner_A UPDATE A1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d7-0000-4000-8000-0000413a66d7''');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000002', 'owner_A-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.skriv_tillatt('bilagssum owner_A UPDATE A2', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d8-0000-4000-8000-0000413a66d8''');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000003', 'owner_A-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.skriv_tillatt('bilagssum owner_A UPDATE A3', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d9-0000-4000-8000-0000413a66d9''');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('bbbb0000-0000-4000-8000-000000000000', 'b1110000-0000-4000-8000-000000000001', 'owner_A-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.skriv_avvist('bilagssum owner_A UPDATE B1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66f6-0000-4000-8000-0000413a66f6''', 'bilagssum', '413a66f6-0000-4000-8000-0000413a66f6', 'id');
select pg_temp.paastand('bilagssum owner_A ser kjedens null-stasjonsrad', exists (select 1 from public.bilagssum where id = '1f29199e-0000-4000-8000-00001f29199e'), 'positiv');
select pg_temp.paastand('bilagssum owner_A ser IKKE den andre kjedens null-rad', not exists (select 1 from public.bilagssum where id = '1f29199f-0000-4000-8000-00001f29199f'), 'negativ');

select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a001');   -- manager_A1
select pg_temp.paastand('bilagssum manager_A1 SELECT A1 -> ser', exists (select 1 from public.bilagssum where id = '413a66d7-0000-4000-8000-0000413a66d7'), 'positiv');
select pg_temp.paastand('bilagssum manager_A1 SELECT A2 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66d8-0000-4000-8000-0000413a66d8'), 'negativ');
select pg_temp.paastand('bilagssum manager_A1 SELECT A3 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66d9-0000-4000-8000-0000413a66d9'), 'negativ');
select pg_temp.paastand('bilagssum manager_A1 SELECT B1 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66f6-0000-4000-8000-0000413a66f6'), 'negativ');
select pg_temp.skriv_avvist('bilagssum manager_A1 INSERT A1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000001'', ''0296'', date ''2026-01-01'' + 296, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde manager_A1A1'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum manager_A1 INSERT A2', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000002'', ''0297'', date ''2026-01-01'' + 297, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde manager_A1A2'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum manager_A1 INSERT A3', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000003'', ''0298'', date ''2026-01-01'' + 298, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde manager_A1A3'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum manager_A1 INSERT B1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''bbbb0000-0000-4000-8000-000000000000'', ''b1110000-0000-4000-8000-000000000001'', ''0299'', date ''2026-01-01'' + 299, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde manager_A1B1'', 1234.50)');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000001', 'manager_A1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a001');
select pg_temp.skriv_avvist('bilagssum manager_A1 UPDATE A1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d7-0000-4000-8000-0000413a66d7''', 'bilagssum', '413a66d7-0000-4000-8000-0000413a66d7', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000002', 'manager_A1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a001');
select pg_temp.skriv_avvist('bilagssum manager_A1 UPDATE A2', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d8-0000-4000-8000-0000413a66d8''', 'bilagssum', '413a66d8-0000-4000-8000-0000413a66d8', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000003', 'manager_A1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a001');
select pg_temp.skriv_avvist('bilagssum manager_A1 UPDATE A3', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d9-0000-4000-8000-0000413a66d9''', 'bilagssum', '413a66d9-0000-4000-8000-0000413a66d9', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('bbbb0000-0000-4000-8000-000000000000', 'b1110000-0000-4000-8000-000000000001', 'manager_A1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a001');
select pg_temp.skriv_avvist('bilagssum manager_A1 UPDATE B1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66f6-0000-4000-8000-0000413a66f6''', 'bilagssum', '413a66f6-0000-4000-8000-0000413a66f6', 'id');
select pg_temp.paastand('bilagssum manager_A1 ser IKKE kjedens null-stasjonsrad', not exists (select 1 from public.bilagssum where id = '1f29199e-0000-4000-8000-00001f29199e'), 'negativ');
select pg_temp.paastand('bilagssum manager_A1 ser IKKE den andre kjedens null-rad', not exists (select 1 from public.bilagssum where id = '1f29199f-0000-4000-8000-00001f29199f'), 'negativ');

select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a012');   -- manager_A12
select pg_temp.paastand('bilagssum manager_A12 SELECT A1 -> ser', exists (select 1 from public.bilagssum where id = '413a66d7-0000-4000-8000-0000413a66d7'), 'positiv');
select pg_temp.paastand('bilagssum manager_A12 SELECT A2 -> ser', exists (select 1 from public.bilagssum where id = '413a66d8-0000-4000-8000-0000413a66d8'), 'positiv');
select pg_temp.paastand('bilagssum manager_A12 SELECT A3 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66d9-0000-4000-8000-0000413a66d9'), 'negativ');
select pg_temp.paastand('bilagssum manager_A12 SELECT B1 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66f6-0000-4000-8000-0000413a66f6'), 'negativ');
select pg_temp.skriv_avvist('bilagssum manager_A12 INSERT A1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000001'', ''0300'', date ''2026-01-01'' + 300, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde manager_A12A1'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum manager_A12 INSERT A2', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000002'', ''0301'', date ''2026-01-01'' + 301, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde manager_A12A2'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum manager_A12 INSERT A3', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000003'', ''0302'', date ''2026-01-01'' + 302, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde manager_A12A3'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum manager_A12 INSERT B1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''bbbb0000-0000-4000-8000-000000000000'', ''b1110000-0000-4000-8000-000000000001'', ''0303'', date ''2026-01-01'' + 303, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde manager_A12B1'', 1234.50)');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000001', 'manager_A12-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a012');
select pg_temp.skriv_avvist('bilagssum manager_A12 UPDATE A1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d7-0000-4000-8000-0000413a66d7''', 'bilagssum', '413a66d7-0000-4000-8000-0000413a66d7', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000002', 'manager_A12-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a012');
select pg_temp.skriv_avvist('bilagssum manager_A12 UPDATE A2', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d8-0000-4000-8000-0000413a66d8''', 'bilagssum', '413a66d8-0000-4000-8000-0000413a66d8', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000003', 'manager_A12-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a012');
select pg_temp.skriv_avvist('bilagssum manager_A12 UPDATE A3', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d9-0000-4000-8000-0000413a66d9''', 'bilagssum', '413a66d9-0000-4000-8000-0000413a66d9', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('bbbb0000-0000-4000-8000-000000000000', 'b1110000-0000-4000-8000-000000000001', 'manager_A12-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a012');
select pg_temp.skriv_avvist('bilagssum manager_A12 UPDATE B1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66f6-0000-4000-8000-0000413a66f6''', 'bilagssum', '413a66f6-0000-4000-8000-0000413a66f6', 'id');
select pg_temp.paastand('bilagssum manager_A12 ser IKKE kjedens null-stasjonsrad', not exists (select 1 from public.bilagssum where id = '1f29199e-0000-4000-8000-00001f29199e'), 'negativ');
select pg_temp.paastand('bilagssum manager_A12 ser IKKE den andre kjedens null-rad', not exists (select 1 from public.bilagssum where id = '1f29199f-0000-4000-8000-00001f29199f'), 'negativ');

select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a101');   -- tablet_A1
select pg_temp.paastand('bilagssum tablet_A1 SELECT A1 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66d7-0000-4000-8000-0000413a66d7'), 'negativ');
select pg_temp.paastand('bilagssum tablet_A1 SELECT A2 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66d8-0000-4000-8000-0000413a66d8'), 'negativ');
select pg_temp.paastand('bilagssum tablet_A1 SELECT A3 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66d9-0000-4000-8000-0000413a66d9'), 'negativ');
select pg_temp.paastand('bilagssum tablet_A1 SELECT B1 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66f6-0000-4000-8000-0000413a66f6'), 'negativ');
select pg_temp.skriv_avvist('bilagssum tablet_A1 INSERT A1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000001'', ''0304'', date ''2026-01-01'' + 304, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde tablet_A1A1'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum tablet_A1 INSERT A2', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000002'', ''0305'', date ''2026-01-01'' + 305, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde tablet_A1A2'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum tablet_A1 INSERT A3', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000003'', ''0306'', date ''2026-01-01'' + 306, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde tablet_A1A3'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum tablet_A1 INSERT B1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''bbbb0000-0000-4000-8000-000000000000'', ''b1110000-0000-4000-8000-000000000001'', ''0307'', date ''2026-01-01'' + 307, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde tablet_A1B1'', 1234.50)');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000001', 'tablet_A1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a101');
select pg_temp.skriv_avvist('bilagssum tablet_A1 UPDATE A1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d7-0000-4000-8000-0000413a66d7''', 'bilagssum', '413a66d7-0000-4000-8000-0000413a66d7', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000002', 'tablet_A1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a101');
select pg_temp.skriv_avvist('bilagssum tablet_A1 UPDATE A2', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d8-0000-4000-8000-0000413a66d8''', 'bilagssum', '413a66d8-0000-4000-8000-0000413a66d8', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000003', 'tablet_A1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a101');
select pg_temp.skriv_avvist('bilagssum tablet_A1 UPDATE A3', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d9-0000-4000-8000-0000413a66d9''', 'bilagssum', '413a66d9-0000-4000-8000-0000413a66d9', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('bbbb0000-0000-4000-8000-000000000000', 'b1110000-0000-4000-8000-000000000001', 'tablet_A1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a101');
select pg_temp.skriv_avvist('bilagssum tablet_A1 UPDATE B1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66f6-0000-4000-8000-0000413a66f6''', 'bilagssum', '413a66f6-0000-4000-8000-0000413a66f6', 'id');
select pg_temp.paastand('bilagssum tablet_A1 ser IKKE kjedens null-stasjonsrad', not exists (select 1 from public.bilagssum where id = '1f29199e-0000-4000-8000-00001f29199e'), 'negativ');
select pg_temp.paastand('bilagssum tablet_A1 ser IKKE den andre kjedens null-rad', not exists (select 1 from public.bilagssum where id = '1f29199f-0000-4000-8000-00001f29199f'), 'negativ');

select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');   -- owner_B
select pg_temp.paastand('bilagssum owner_B SELECT B1 -> ser', exists (select 1 from public.bilagssum where id = '413a66f6-0000-4000-8000-0000413a66f6'), 'positiv');
select pg_temp.paastand('bilagssum owner_B SELECT B2 -> ser', exists (select 1 from public.bilagssum where id = '413a66f7-0000-4000-8000-0000413a66f7'), 'positiv');
select pg_temp.paastand('bilagssum owner_B SELECT A1 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66d7-0000-4000-8000-0000413a66d7'), 'negativ');
select pg_temp.skriv_tillatt('bilagssum owner_B INSERT B1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''bbbb0000-0000-4000-8000-000000000000'', ''b1110000-0000-4000-8000-000000000001'', ''0308'', date ''2026-01-01'' + 308, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde owner_BB1'', 1234.50)');
select pg_temp.skriv_tillatt('bilagssum owner_B INSERT B2', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''bbbb0000-0000-4000-8000-000000000000'', ''b1110000-0000-4000-8000-000000000002'', ''0309'', date ''2026-01-01'' + 309, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde owner_BB2'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum owner_B INSERT A1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000001'', ''0310'', date ''2026-01-01'' + 310, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde owner_BA1'', 1234.50)');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('bbbb0000-0000-4000-8000-000000000000', 'b1110000-0000-4000-8000-000000000001', 'owner_B-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.skriv_tillatt('bilagssum owner_B UPDATE B1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66f6-0000-4000-8000-0000413a66f6''');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('bbbb0000-0000-4000-8000-000000000000', 'b1110000-0000-4000-8000-000000000002', 'owner_B-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.skriv_tillatt('bilagssum owner_B UPDATE B2', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66f7-0000-4000-8000-0000413a66f7''');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000001', 'owner_B-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.skriv_avvist('bilagssum owner_B UPDATE A1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d7-0000-4000-8000-0000413a66d7''', 'bilagssum', '413a66d7-0000-4000-8000-0000413a66d7', 'id');
select pg_temp.paastand('bilagssum owner_B ser kjedens null-stasjonsrad', exists (select 1 from public.bilagssum where id = '1f29199f-0000-4000-8000-00001f29199f'), 'positiv');
select pg_temp.paastand('bilagssum owner_B ser IKKE den andre kjedens null-rad', not exists (select 1 from public.bilagssum where id = '1f29199e-0000-4000-8000-00001f29199e'), 'negativ');

select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b001');   -- manager_B1
select pg_temp.paastand('bilagssum manager_B1 SELECT B1 -> ser', exists (select 1 from public.bilagssum where id = '413a66f6-0000-4000-8000-0000413a66f6'), 'positiv');
select pg_temp.paastand('bilagssum manager_B1 SELECT B2 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66f7-0000-4000-8000-0000413a66f7'), 'negativ');
select pg_temp.paastand('bilagssum manager_B1 SELECT A1 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66d7-0000-4000-8000-0000413a66d7'), 'negativ');
select pg_temp.skriv_avvist('bilagssum manager_B1 INSERT B1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''bbbb0000-0000-4000-8000-000000000000'', ''b1110000-0000-4000-8000-000000000001'', ''0311'', date ''2026-01-01'' + 311, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde manager_B1B1'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum manager_B1 INSERT B2', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''bbbb0000-0000-4000-8000-000000000000'', ''b1110000-0000-4000-8000-000000000002'', ''0312'', date ''2026-01-01'' + 312, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde manager_B1B2'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum manager_B1 INSERT A1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000001'', ''0313'', date ''2026-01-01'' + 313, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde manager_B1A1'', 1234.50)');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('bbbb0000-0000-4000-8000-000000000000', 'b1110000-0000-4000-8000-000000000001', 'manager_B1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b001');
select pg_temp.skriv_avvist('bilagssum manager_B1 UPDATE B1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66f6-0000-4000-8000-0000413a66f6''', 'bilagssum', '413a66f6-0000-4000-8000-0000413a66f6', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('bbbb0000-0000-4000-8000-000000000000', 'b1110000-0000-4000-8000-000000000002', 'manager_B1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b001');
select pg_temp.skriv_avvist('bilagssum manager_B1 UPDATE B2', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66f7-0000-4000-8000-0000413a66f7''', 'bilagssum', '413a66f7-0000-4000-8000-0000413a66f7', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000001', 'manager_B1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b001');
select pg_temp.skriv_avvist('bilagssum manager_B1 UPDATE A1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d7-0000-4000-8000-0000413a66d7''', 'bilagssum', '413a66d7-0000-4000-8000-0000413a66d7', 'id');
select pg_temp.paastand('bilagssum manager_B1 ser IKKE kjedens null-stasjonsrad', not exists (select 1 from public.bilagssum where id = '1f29199f-0000-4000-8000-00001f29199f'), 'negativ');
select pg_temp.paastand('bilagssum manager_B1 ser IKKE den andre kjedens null-rad', not exists (select 1 from public.bilagssum where id = '1f29199e-0000-4000-8000-00001f29199e'), 'negativ');

select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b101');   -- tablet_B1
select pg_temp.paastand('bilagssum tablet_B1 SELECT B1 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66f6-0000-4000-8000-0000413a66f6'), 'negativ');
select pg_temp.paastand('bilagssum tablet_B1 SELECT B2 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66f7-0000-4000-8000-0000413a66f7'), 'negativ');
select pg_temp.paastand('bilagssum tablet_B1 SELECT A1 -> ser ikke', not exists (select 1 from public.bilagssum where id = '413a66d7-0000-4000-8000-0000413a66d7'), 'negativ');
select pg_temp.skriv_avvist('bilagssum tablet_B1 INSERT B1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''bbbb0000-0000-4000-8000-000000000000'', ''b1110000-0000-4000-8000-000000000001'', ''0314'', date ''2026-01-01'' + 314, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde tablet_B1B1'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum tablet_B1 INSERT B2', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''bbbb0000-0000-4000-8000-000000000000'', ''b1110000-0000-4000-8000-000000000002'', ''0315'', date ''2026-01-01'' + 315, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde tablet_B1B2'', 1234.50)');
select pg_temp.skriv_avvist('bilagssum tablet_B1 INSERT A1', 'insert into public.bilagssum (retailer_id, stasjon_id, butikknummer, periode, rapportlinje, konto, begrep, tekst, belop_kr) values (''aaaa0000-0000-4000-8000-000000000000'', ''a1110000-0000-4000-8000-000000000001'', ''0316'', date ''2026-01-01'' + 316, ''627 Renhold'', ''6270 Renhold'', ''renhold'', ''Sonde tablet_B1A1'', 1234.50)');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('bbbb0000-0000-4000-8000-000000000000', 'b1110000-0000-4000-8000-000000000001', 'tablet_B1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b101');
select pg_temp.skriv_avvist('bilagssum tablet_B1 UPDATE B1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66f6-0000-4000-8000-0000413a66f6''', 'bilagssum', '413a66f6-0000-4000-8000-0000413a66f6', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('bbbb0000-0000-4000-8000-000000000000', 'b1110000-0000-4000-8000-000000000002', 'tablet_B1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b101');
select pg_temp.skriv_avvist('bilagssum tablet_B1 UPDATE B2', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66f7-0000-4000-8000-0000413a66f7''', 'bilagssum', '413a66f7-0000-4000-8000-0000413a66f7', 'id');
select pg_temp.som_eier();
select pg_temp.nyrad_bilagssum('aaaa0000-0000-4000-8000-000000000000', 'a1110000-0000-4000-8000-000000000001', 'tablet_B1-update') as _;
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b101');
select pg_temp.skriv_avvist('bilagssum tablet_B1 UPDATE A1', 'update public.bilagssum set belop_kr = 2345.60 where id = ''413a66d7-0000-4000-8000-0000413a66d7''', 'bilagssum', '413a66d7-0000-4000-8000-0000413a66d7', 'id');
select pg_temp.paastand('bilagssum tablet_B1 ser IKKE kjedens null-stasjonsrad', not exists (select 1 from public.bilagssum where id = '1f29199f-0000-4000-8000-00001f29199f'), 'negativ');
select pg_temp.paastand('bilagssum tablet_B1 ser IKKE den andre kjedens null-rad', not exists (select 1 from public.bilagssum where id = '1f29199e-0000-4000-8000-00001f29199e'), 'negativ');
...
select pg_temp.skriv_tillatt('bp_aar owner_A INSERT A1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000001'', ''aaaa0000-0000-4000-8000-000000000000'', 2417, ''st1_bp26'', 12000)');
select pg_temp.skriv_tillatt('bp_aar owner_A INSERT A2', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000002'', ''aaaa0000-0000-4000-8000-000000000000'', 2418, ''st1_bp26'', 12000)');
select pg_temp.skriv_tillatt('bp_aar owner_A INSERT A3', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000003'', ''aaaa0000-0000-4000-8000-000000000000'', 2419, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar owner_A INSERT B1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''b1110000-0000-4000-8000-000000000001'', ''bbbb0000-0000-4000-8000-000000000000'', 2420, ''st1_bp26'', 12000)');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bp_aar (id, stasjon_id, retailer_id, ar, format, timer_aar) values ('f4eb7255-0000-4000-8000-0000f4eb7255', 'a1110000-0000-4000-8000-000000000001', 'aaaa0000-0000-4000-8000-000000000000', 2421, 'st1_bp26', 12000);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bp_aar (id, stasjon_id, retailer_id, ar, format, timer_aar) values ('f4eb7256-0000-4000-8000-0000f4eb7256', 'a1110000-0000-4000-8000-000000000002', 'aaaa0000-0000-4000-8000-000000000000', 2422, 'st1_bp26', 12000);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bp_aar (id, stasjon_id, retailer_id, ar, format, timer_aar) values ('f4eb7257-0000-4000-8000-0000f4eb7257', 'a1110000-0000-4000-8000-000000000003', 'aaaa0000-0000-4000-8000-000000000000', 2423, 'st1_bp26', 12000);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
...
select pg_temp.skriv_avvist('bp_aar manager_A1 INSERT A1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000001'', ''aaaa0000-0000-4000-8000-000000000000'', 2424, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar manager_A1 INSERT A2', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000002'', ''aaaa0000-0000-4000-8000-000000000000'', 2425, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar manager_A1 INSERT A3', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000003'', ''aaaa0000-0000-4000-8000-000000000000'', 2426, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar manager_A1 INSERT B1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''b1110000-0000-4000-8000-000000000001'', ''bbbb0000-0000-4000-8000-000000000000'', 2427, ''st1_bp26'', 12000)');
select pg_temp.som_eier();
...
select pg_temp.skriv_avvist('bp_aar manager_A12 INSERT A1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000001'', ''aaaa0000-0000-4000-8000-000000000000'', 2428, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar manager_A12 INSERT A2', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000002'', ''aaaa0000-0000-4000-8000-000000000000'', 2429, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar manager_A12 INSERT A3', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000003'', ''aaaa0000-0000-4000-8000-000000000000'', 2430, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar manager_A12 INSERT B1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''b1110000-0000-4000-8000-000000000001'', ''bbbb0000-0000-4000-8000-000000000000'', 2431, ''st1_bp26'', 12000)');
select pg_temp.som_eier();
...
select pg_temp.skriv_avvist('bp_aar tablet_A1 INSERT A1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000001'', ''aaaa0000-0000-4000-8000-000000000000'', 2432, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar tablet_A1 INSERT A2', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000002'', ''aaaa0000-0000-4000-8000-000000000000'', 2433, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar tablet_A1 INSERT A3', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000003'', ''aaaa0000-0000-4000-8000-000000000000'', 2434, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar tablet_A1 INSERT B1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''b1110000-0000-4000-8000-000000000001'', ''bbbb0000-0000-4000-8000-000000000000'', 2435, ''st1_bp26'', 12000)');
select pg_temp.som_eier();
...
select pg_temp.skriv_tillatt('bp_aar owner_B INSERT B1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''b1110000-0000-4000-8000-000000000001'', ''bbbb0000-0000-4000-8000-000000000000'', 2436, ''st1_bp26'', 12000)');
select pg_temp.skriv_tillatt('bp_aar owner_B INSERT B2', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''b1110000-0000-4000-8000-000000000002'', ''bbbb0000-0000-4000-8000-000000000000'', 2437, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar owner_B INSERT A1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000001'', ''aaaa0000-0000-4000-8000-000000000000'', 2438, ''st1_bp26'', 12000)');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bp_aar (id, stasjon_id, retailer_id, ar, format, timer_aar) values ('f4eb7274-0000-4000-8000-0000f4eb7274', 'b1110000-0000-4000-8000-000000000001', 'bbbb0000-0000-4000-8000-000000000000', 2439, 'st1_bp26', 12000);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.som_eier();
...
select pg_temp.som_eier();
insert into public.bp_aar (id, stasjon_id, retailer_id, ar, format, timer_aar) values ('f4eb7275-0000-4000-8000-0000f4eb7275', 'b1110000-0000-4000-8000-000000000002', 'bbbb0000-0000-4000-8000-000000000000', 2440, 'st1_bp26', 12000);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.som_eier();
...
select pg_temp.skriv_avvist('bp_aar manager_B1 INSERT B1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''b1110000-0000-4000-8000-000000000001'', ''bbbb0000-0000-4000-8000-000000000000'', 2441, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar manager_B1 INSERT B2', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''b1110000-0000-4000-8000-000000000002'', ''bbbb0000-0000-4000-8000-000000000000'', 2442, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar manager_B1 INSERT A1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000001'', ''aaaa0000-0000-4000-8000-000000000000'', 2443, ''st1_bp26'', 12000)');
select pg_temp.som_eier();
...
select pg_temp.skriv_avvist('bp_aar tablet_B1 INSERT B1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''b1110000-0000-4000-8000-000000000001'', ''bbbb0000-0000-4000-8000-000000000000'', 2444, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar tablet_B1 INSERT B2', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''b1110000-0000-4000-8000-000000000002'', ''bbbb0000-0000-4000-8000-000000000000'', 2445, ''st1_bp26'', 12000)');
select pg_temp.skriv_avvist('bp_aar tablet_B1 INSERT A1', 'insert into public.bp_aar (stasjon_id, retailer_id, ar, format, timer_aar) values (''a1110000-0000-4000-8000-000000000001'', ''aaaa0000-0000-4000-8000-000000000000'', 2446, ''st1_bp26'', 12000)');
select pg_temp.som_eier();
...
begin
  ...
  if n > 0 then
    raise exception 'TENANT-MATRISEN DEL 2/11: % funn. Se tabellen over.', n;
  end if;
  raise notice '--- Tenant-matrisen DEL 2/11: ingen funn. % paastander ---',
