...
select pg_temp.som_eier();
delete from public.bemanning_budsjett where id = 'c4b6d3e5-0000-4000-8000-0000c4b6d3e5';
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
...
select pg_temp.som_eier();
delete from public.bemanning_budsjett where id = 'c4b6d3e5-0000-4000-8000-0000c4b6d3e5';
insert into public.bemanning_budsjett (stasjon_id, ar, maned, timer, lonn_kr, brutto_bp_kr) values ('a1110000-0000-4000-8000-000000000001', 2026, 8, 1000, 400000, 900000);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
delete from public.bemanning_budsjett where id = 'c4b6d3e6-0000-4000-8000-0000c4b6d3e6';
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
...
select pg_temp.som_eier();
delete from public.bemanning_budsjett where id = 'c4b6d3e6-0000-4000-8000-0000c4b6d3e6';
insert into public.bemanning_budsjett (stasjon_id, ar, maned, timer, lonn_kr, brutto_bp_kr) values ('a1110000-0000-4000-8000-000000000002', 2026, 8, 1000, 400000, 900000);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
delete from public.bemanning_budsjett where id = 'c4b6d3e7-0000-4000-8000-0000c4b6d3e7';
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
...
select pg_temp.som_eier();
delete from public.bemanning_budsjett where id = 'c4b6d3e7-0000-4000-8000-0000c4b6d3e7';
insert into public.bemanning_budsjett (stasjon_id, ar, maned, timer, lonn_kr, brutto_bp_kr) values ('a1110000-0000-4000-8000-000000000003', 2026, 8, 1000, 400000, 900000);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
select pg_temp.som_eier();
delete from public.bemanning_budsjett where id = 'c4b6d404-0000-4000-8000-0000c4b6d404';
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
...
select pg_temp.som_eier();
delete from public.bemanning_budsjett where id = 'c4b6d404-0000-4000-8000-0000c4b6d404';
insert into public.bemanning_budsjett (stasjon_id, ar, maned, timer, lonn_kr, brutto_bp_kr) values ('b1110000-0000-4000-8000-000000000001', 2026, 8, 1000, 400000, 900000);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000a000');
...
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.som_eier();
delete from public.bemanning_budsjett where id = 'c4b6d405-0000-4000-8000-0000c4b6d405';
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
...
select pg_temp.som_eier();
delete from public.bemanning_budsjett where id = 'c4b6d405-0000-4000-8000-0000c4b6d405';
insert into public.bemanning_budsjett (stasjon_id, ar, maned, timer, lonn_kr, brutto_bp_kr) values ('b1110000-0000-4000-8000-000000000002', 2026, 8, 1000, 400000, 900000);
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
select pg_temp.som_eier();
delete from public.bemanning_budsjett where id = 'c4b6d3e5-0000-4000-8000-0000c4b6d3e5';
select pg_temp.logg_inn_som('00000000-0000-0000-0000-00000000b000');
