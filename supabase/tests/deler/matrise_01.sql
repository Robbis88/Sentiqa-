...
--
-- DEL 1 AV 11. Hele matrisen er for stor for Supabase SQL
...
begin
  ...
  if n > 0 then
    raise exception 'TENANT-MATRISEN DEL 1/11: % funn. Se tabellen over.', n;
  end if;
  raise notice '--- Tenant-matrisen DEL 1/11: ingen funn. % paastander ---',
