...
-- alltid uten et grep aa ta - begrunnelsen den gang var at
-- differansen ER avtalene. Den begrunnelsen holdt ikke (se den lange
-- kommentaren ved `brutto_mot_bp_pp` under), men konklusjonen staar:
-- budsjettet er den riktige maalestokken for drift.
--
