-- =====================================================================
-- v_timeregnskap: en delvis maaned skal se delvis ut
--
-- Salgstallene stopper paa gaarsdagen. I august 2026 betyr det 20 av 31
-- dager - og da er `realisert_brutto` to tredjedeler av en maaned, mens
-- `budsjett_timer` er hele.
--
-- REGNESTYKKET ER RIKTIG. Baade opptjente og brukte timer er delvise i
-- samme grad, saa `timer_over` stemmer. Det er LESNINGEN som er feil:
-- «384 opptjente av 714 i rammen» leses som katastrofe naar det
-- egentlig er «to tredjedeler av maaneden er talt».
--
-- Robert, 2026-08-22, om restansene: «august lyver visuelt».
--
-- Viewet sier naa hvor mye av maaneden som er med, saa sida kan skille
-- avsluttede maaneder fra den som paagaar. Den slags forskjell er
-- noeyaktig det som blir feiltolket naar noen ser tallet i en travel
-- time.
--
-- DAGER MED SALG, IKKE DAGER I KALENDEREN. En stasjon som er stengt
-- mandager har ikke 31 salgsdager i mars - men den har heller ikke et
-- hull. Vi teller derfor til SISTE dagen med salg, ikke antall dager
-- med rader: 20 av 31 betyr «vi har tall til og med den 20.».
-- =====================================================================
...
select
  ...
  -- HVOR MYE AV MAANEDEN SOM ER TALT. `dager_med_salg` er dagnummeret
  -- til siste salgsdag, ikke antall rader: en stasjon som er stengt
  -- mandager har faerre rader, men ikke et hull i perioden.
  --
  -- Er de to like, er maaneden avsluttet. Er de ulike, paagaar den -
  -- og da kan ikke opptjente timer sammenlignes med en hel ramme uten
  -- at noen sier fra.
