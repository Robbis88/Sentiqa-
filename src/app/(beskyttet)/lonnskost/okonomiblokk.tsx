...
import { Tallrad } from '@/components/ui/okonomi'
...
// Lov 3 sier at kilden følger med ut, og at flaten aldri skal finne den
// selv.
//
...
// brukeren trenger.
//
// `Tallrad` og `HvaBoerJegVite` LÅ HER OG ER LØFTET, etter nøyaktig den
// regelen: «Min måned» ble den andre brukeren. De står i
// `components/ui/okonomi.tsx` nå. Lønnsblokken ble stående, fordi den
// fortsatt har én.
// =====================================================================
